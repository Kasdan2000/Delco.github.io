...
document.querySelector("#modalContacto")
 ...
 const abrirServicios = () => {
    ...
    document.querySelector("#articleButton1").style.display = "none";
    document.querySelector("#boton1Cerrar").style.display = "block";
    document.querySelector("#articleButtonInverso1").style.display = "block";
}
...
const cerrarServicios = () => {
    ...
    document.querySelector("#articleButton1").style.display = "block";
    document.querySelector("#articleButtonInverso1").style.display = "none";
}
...
const abrirMetodos = () => {
    ...
    document.querySelector("#articleButton2").style.display = "none";
    document.querySelector("#articleButtonInverso2").style.display = "block";
}
...
const cerrarMetodos = () => {
    ...
    document.querySelector("#articleButton2").style.display = "block";
    document.querySelector("#articleButtonInverso2").style.display = "none";
}
...
const abrirHorarios = () => {
    ...
    document.querySelector("#articleButton3").style.display = "none";
    document.querySelector("#articleButtonInverso3").style.display = "block";
}
...
const cerrarHorarios = () => {
    ...
    document.querySelector("#articleButton3").style.display = "block";
    document.querySelector("#articleButtonInverso3t").style.display = "none";
}
